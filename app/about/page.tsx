  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row justify-center p-8 ">
      ...
      <div className="text-left lg:w-1/3 mb-8 lg:mb-0">
        ...
        <p>
            I’m Andrea—a software engineer and designer based in Singapore,
            currently pursuing a major in Computer Science with a minor in Data
            Science and AI, specializing in Financial Technology. I’m
            passionate about blending creativity with technology to bring
            innovative ideas to life.
          </p>
          <br />
          <p>
            Currently, I’m on the lookout for an internship where I can apply
            my skills and grow professionally.
          </p>
          <br />
          <p>
            Beyond my studies, I’m working on developing a water filtration
            product designed to support people with sensitive skin, enhancing
            overall wellness and beauty. On top of that, I’m also the
            co-founder of a café startup, which serves refreshing açaí bowls
            and coffee.
          </p>
          <br />
          <p>
            I’m all about curiosity and capturing life’s little moments. When
            I’m not gathering inspiration, you’ll find me in Visual Studio
            bringing ideas to life.
          </p>
          <br />
          <p>
            Oh, and you’ll never catch me in a bad outfit—With a keen eye for
